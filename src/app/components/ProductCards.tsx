    ...
    <div className="w-full">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {allProducts.map((product) => (
          <div
            key={product.id}
            className="group relative overflow-hidden bg-[#1a1a1a] rounded-2xl p-6 border border-white/5 hover:border-white/10 transition-all duration-300"
          >
            {/* Background Gradient */}
            ...
            <div className="relative">
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                <button className="flex items-center gap-2 text-xs text-white/50 hover:text-white group-hover:text-white/70 transition-colors">
                  Order
